namespace Simple.WebSockets.Shared.Helpers
{
    using System;
    using System.Text;
    ...
    public class Utilities
    {
        ...
        /// <summary>
        /// Generates a unique identifier using a customised "ShortGuid"
        /// </summary>
        /// <returns>Generated Identifier</returns>
        public static string GenerateIdentifier(int iterations = 1)
        {
            var stringBuilder = new StringBuilder();

            for (var i = 0; i < iterations + 1; i++)
            {
                stringBuilder.Append(ToShortGuid(Guid.NewGuid()));
            }

            return stringBuilder.ToString().ToLower().Replace("_", "0").Replace("-", "9");
        }

        /// <summary>
        /// Converts from a <see cref="Guid"/> to a ShortGuid
        /// </summary>
        /// <param name="guid">Guid Value</param>
        /// <returns>Short Guid Value</returns>
